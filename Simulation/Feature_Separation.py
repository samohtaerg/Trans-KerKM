...
Original file is located at
    https://colab.research.google.com/drive/1Oge85sf0Ts0f5HXr66OhqU3jqlLEVjeK
"""
...
def generate_multigroup_data(n_source=1000, n_target=200, n_groups=5, source_mix=None, target_mix=None, distribution_type=None, data_type=None,
    ...
    for g in range(n_groups):
        ...
        if n_g > 0:
            ...
            print(f"[CENSOR][Feature_Separation] level={feature_spread} group={g+1} n={n_g} "
...
if __name__ == "__main__":
    ...
    feature_spread_values = [0, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2]
